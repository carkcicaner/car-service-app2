            ...
            >
                ...
                <div className="space-y-4 text-sm">
                    ...
                    <div>
                        ...
                        <p>{record.accidentDescription}</p>
                    </div>
                    ...
                    {record.invoicePhoto && (
                        <div>
                            ...
                            <img src={record.invoicePhoto} alt="Fatura" className="rounded-lg shadow-md max-h-60 w-auto mx-auto"/>
                        </div>
                    )}
                </div>
                 ...
                 <div className="mt-6 border-t pt-4">
                    <button 
                        onClick={onClose} 
                        className="w-full bg-gray-600 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline transition-colors"
                    >
                        Kapat
                    </button>
                </div>
